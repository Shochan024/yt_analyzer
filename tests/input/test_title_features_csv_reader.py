  ...
  def test_read_parses_records_and_blank_optional_values(self):
    with tempfile.TemporaryDirectory() as directory:
      ...
      path.write_text(
        ...
        "video-1,title,long,20,10,4.5,0.2,1,8.5,0.12,,,,50,26,2,2026-03-24\n"
        "video-2,title,short,30,12,5.5,0.1,0,9.5,,0.42,0.65,120,13,0,1,2026-09-19\n",
        encoding="utf-8"
      )
    ...
    self.assertEqual(records[0].likes, 50)
    self.assertEqual(records[0].subscribers_gained, 26)
    self.assertEqual(records[0].comments, 2)
    self.assertEqual(records[0].published_at, "2026-03-24")
